...
const galleryBeforeAfter1 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663521790732/H6h3DFAC5oGrg4e2N8kyZS/gallery-before-after-1_79cdc9c6.jpg";
const galleryBeforeAfter2 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663521790732/H6h3DFAC5oGrg4e2N8kyZS/gallery-before-after-2_b0e545e3.jpg";
const serviceFacialTreatment = "/cleansing.jpg";
const serviceHydration = "/hydration.webp";
const serviceAntiAging =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663521790732/H6h3DFAC5oGrg4e2N8kyZS/service-anti-aging_12fab4cc.jpg";
const serviceDeepCleanse =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663521790732/H6h3DFAC5oGrg4e2N8kyZS/service-deep-cleanse_a4865812.jpg";
const serviceConsultation =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663521790732/H6h3DFAC5oGrg4e2N8kyZS/service-consultation_6b5f33ba.jpg";
...
const pricelist = [
  {
    ...
    price: 50,
    description:
      "Individuali odos analizė ir geriausios procedūros rekomendacija",
...
const services = [
  {
    ...
    title: "Veido valymas",
    description:
      "Profesionali veido valymo procedūra, skirta pašalinti nešvarumams ir atgaivinti odą.",
    icon: "✨",
  ...
  },
  {
    ...
    title: "Hidratacija",
    description:
      "Intensyvi odos drėkinimo procedūra su premium serumais ir kaukėmis.",
    icon: "💧",
  ...
  },
  {
    ...
    description:
      "Procedūros, skirtos sumažinti raukšles ir atgaivinti odos elastingumą.",
    icon: "✨",
  ...
  },
  {
    ...
    title: "Akių zona",
    description:
      "Specialios procedūros akių zonai, skirtos sumažinti tamsias dėmes ir patinimą.",
    icon: "👁️",
  ...
  },
  {
    ...
    title: "Burnos zona",
    description:
      "Intensyvi procedūra burnos zonai, skirta suteikti jaunystės ženklus.",
    icon: "💋",
    image:
      "https://d2xsxph8kpxj0f.cloudfront.net/310519663521790732/H6h3DFAC5oGrg4e2N8kyZS/service-facial-treatment_b41ba2d1.jpg",
  },
  {
    id: 6,
    title: "Konsultacija",
    description:
      "Individuali konsultacija apie jūsų odos poreikius. Visiškai nemokama.",
    icon: "💬",
...
const testimonials = [
  {
    name: "Laima",
    text: "Nuo pirmos procedūros pastebėjau didelį skirtumą. Mano oda dabar žvaigždi ir sveika. Labai rekomenduoju!",
    rating: 5,
  },
  {
    name: "Rasa",
    text: "Profesionali meistrė, šilta atmosfera ir puikūs rezultatai. Jau 6 mėnesius einu pas ją ir labai patenkinta.",
    rating: 5,
  },
  {
    name: "Kristina",
    text: "Geriausios kosmetologijos procedūros, kurias esu turėjusi. Visada jaučiuosi puikiai po vizito.",
    rating: 5,
  },
];
        ...
        >
          ...
          <div className="container relative z-10 text-center text-white">
            <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight">
              Jūsų oda nusipelnė prabangos
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-2xl mx-auto">
              Premium kosmetologijos procedūros, skirtos jūsų odos grožiui ir
              sveikatai
            </p>
            <button
              onClick={() =>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="pl-8 md:pl-16">
                ...
                <p className="text-lg text-foreground/80 mb-4 leading-relaxed">
                  Aš esu profesionali kosmetologijos meistrė su daugiau nei 10
                  metų patirtimi. Mano tikslas – padėti jums pasijusti gražiai
                  ir pasitikinti savimi.
                </p>
                <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
                  Naudoju tik geriausias, sertifikuotas medžiagas ir
                  šiuolaikines technologijas, kad garantuočiau jums saugiausias
                  ir efektyviausias procedūras.
                </p>
                <div className="space-y-3">
                  {[
                    "Sertifikuota kosmetologė",
                    "10+ metų patirtis",
                    "Premium medžiagos",
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-sm text-primary font-medium tracking-wide uppercase mt-1">
                    Kosmetologė
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
                Profesionalios kosmetologijos procedūros, skirtos jūsų odos
                poreikiams
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {services.map(service => (
                <div
                  key={service.id}
                  className="group relative overflow-hidden rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-primary/10 bg-white"
                >
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pricelist.map(service => (
                <div
                  key={service.id}
                  className="group bg-white p-8 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-primary/10"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[galleryBeforeAfter2, beforeAfterImage, productsImage].map(
                (img, i) => (
                  <div
                    key={i}
                    className="group relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow aspect-[3/2]"
                  >
                    <img
                      src={img}
                      alt={`Galerija ${i + 1}`}
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((t, i) => (
                <div
                  key={i}
                  className="bg-white p-8 rounded-2xl shadow-md border border-primary/10 hover:shadow-lg transition-shadow"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <p className="font-serif font-bold text-foreground mb-2">
                      Telefonas
                    </p>
                    <a
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@kosmetologija.lt"
                      className="text-primary hover:text-primary/80 transition-colors text-lg"
                    >
                      info@kosmetologija.lt
                    </a>
                  </div>
                  <div>
                    <p className="font-serif font-bold text-foreground mb-2">
